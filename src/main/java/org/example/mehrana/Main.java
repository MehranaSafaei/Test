            ...
            try {
                ...
                switch (choice) {
                    ...
                    case 8:
                        ...
                        List<PersonnelDto> personnels = personnelService.findByUsername(username);
                    ...
                    case 9:
                        ...
                        break;
                    case 10:
                        //TODO: I write code DELETE METHOD means: personnel enter 2 Leaves and after want to delete one of the leave
                        System.out.print("Enter your username: ");
                        String username1 = scanner.nextLine();

                        List<Leave> personnelUsername = leaveService.findAllByPersonnelUername(username1);
                        // iter
                        for (Leave leave : personnelUsername) {
                            showLeave(leave);
                        }

                        System.out.print("please select one of the id for delete: ");
                        long id = scanner.nextLong();

                        Optional<Leave> optionalLeave = personnelUsername.stream().filter(x -> x.getId() == id).findFirst();
